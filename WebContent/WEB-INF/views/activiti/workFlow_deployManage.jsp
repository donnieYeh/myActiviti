...
<script type="text/javascript">
	...
	function showDiagram(name,id){
		var url ="activiti/workFlow!showDiagram.do?procDefId="+id;
				...
				<tbody>
					<s:iterator value="#deployList">
						<tr>
							...
							<td><a href="workFlow!deleteDeployment.do?deployId=<s:property value="id" />">删除</a></td>
						</tr>
					</s:iterator>
				</tbody>
			</table>
				...
				<tbody>
					<s:iterator value="#prodefList">
						<tr>
							...
							<td><a href="#" onclick="showDiagram('<s:property value='name' />','<s:property value='id' />')">查看流程图</a></td>
						</tr>
					</s:iterator>
				</tbody>
			</table>
