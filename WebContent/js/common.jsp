...
<link rel="stylesheet" type="text/css" href="<%=contextPath %>/js/jquery-easyui-1.4.4/themes/icon.css">
<link rel="stylesheet" type="text/css" href="<%=contextPath %>/js/jquery-easyui-1.4.4/themes/color.css">
